...
{ 
   ...
   {  
     //Menu de opcoes 
      ...
      printf(" | <S>  Sair                                                                  |\n");
      printf(" |----------------------------------------------------------------------------|\n");
      printf(" |                                             Designed por Leonardo e Simao  |\n");
      printf(" %c----------------------------------------------------------------------------%c\n",200,188);
...
//Função para registar restaurantes.
Lista* inserir_restaurantes (Lista *primeiro){ 
     Lista restaurante;
...
//Função para apresentar todos os restaurantes registados.
void listar_restaurantes (Lista* primeiro){
...
//Função para excluir restaurantes.
Lista* excluir_restaurantes(Lista *primeiro){
